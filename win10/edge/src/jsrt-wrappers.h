...
namespace jsrt
{
    ...
    public:
        ...
        static runtime create(JsRuntimeAttributes attributes = JsRuntimeAttributeNone, JsThreadServiceCallback callback = nullptr)
        {
            JsRuntimeHandle newRuntime;
            runtime::translate_error_code(JsCreateRuntime(attributes, callback, &newRuntime));
