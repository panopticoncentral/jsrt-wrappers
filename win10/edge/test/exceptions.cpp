...
namespace jsrtwrapperstest
{
    ...
    public:
        ...
        {
            jsrt::runtime runtime = jsrt::runtime::create(JsRuntimeAttributeNone, thread_service);
            jsrt::context context = runtime.create_context();
            {
                jsrt::context::scope scope(context);
        ...
        MY_TEST_METHOD(already_debugging_context, "Test already_debugging_context_exception.")
        {
            ...
            jsrt::context context = runtime.create_context();
            {
                jsrt::context::scope scope(context);
                jsrt::context::start_debugging();
                TEST_FAILED_CALL(jsrt::context::start_debugging(), already_debugging_context_exception);
            }
            runtime.dispose();
        }
