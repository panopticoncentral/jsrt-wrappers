...
namespace jsrtwrapperstest
{
    ...
    public:
        ...
        MY_TEST_METHOD(no_context, "Test calls with no context.")
        {
            ...
            TEST_NO_CONTEXT_CALL((jsrt::function<double, std::wstring, double, bool, std::wstring, double, bool, std::wstring, double>::create(L"foo", nullptr)));
            ...
            TEST_NO_CONTEXT_CALL((jsrt::function<double, std::wstring, double, bool, std::wstring, double, bool, std::wstring>::create(L"foo", nullptr)));
            ...
            TEST_NO_CONTEXT_CALL((jsrt::function<double, std::wstring, double, bool, std::wstring, double, bool>::create(L"foo", nullptr)));
            ...
            TEST_NO_CONTEXT_CALL((jsrt::function<double, std::wstring, double, bool, std::wstring, double>::create(L"foo", nullptr)));
            ...
            TEST_NO_CONTEXT_CALL((jsrt::function<double, std::wstring, double, bool, std::wstring>::create(L"foo", nullptr)));
            ...
            TEST_NO_CONTEXT_CALL((jsrt::function<double, std::wstring, double, bool>::create(L"foo", nullptr)));
            ...
            TEST_NO_CONTEXT_CALL((jsrt::function<double, std::wstring, double>::create(L"foo", nullptr)));
            TEST_NO_CONTEXT_CALL((f2(this_value, L"foo", 2)));
            TEST_NO_CONTEXT_CALL((jsrt::function<double, std::wstring>::create(nullptr)));
            TEST_NO_CONTEXT_CALL((jsrt::function<double, std::wstring>::create(L"foo", nullptr)));
            TEST_NO_CONTEXT_CALL((f1(this_value, L"foo")));
            TEST_NO_CONTEXT_CALL((jsrt::function<double>::create(nullptr)));
            TEST_NO_CONTEXT_CALL((jsrt::function<double>::create(L"foo", nullptr)));
            ...
            TEST_NO_CONTEXT_CALL((jsrt::function<void, std::wstring, double, bool, std::wstring, double, bool, std::wstring, double>::create(L"foo", nullptr)));
            ...
            TEST_NO_CONTEXT_CALL((jsrt::function<void, std::wstring, double, bool, std::wstring, double, bool, std::wstring>::create(L"foo", nullptr)));
            ...
            TEST_NO_CONTEXT_CALL((jsrt::function<void, std::wstring, double, bool, std::wstring, double, bool>::create(L"foo", nullptr)));
            ...
            TEST_NO_CONTEXT_CALL((jsrt::function<void, std::wstring, double, bool, std::wstring, double>::create(L"foo", nullptr)));
            ...
            TEST_NO_CONTEXT_CALL((jsrt::function<void, std::wstring, double, bool, std::wstring>::create(L"foo", nullptr)));
            ...
            TEST_NO_CONTEXT_CALL((jsrt::function<void, std::wstring, double, bool>::create(L"foo", nullptr)));
            ...
            TEST_NO_CONTEXT_CALL((jsrt::function<void, std::wstring, double>::create(L"foo", nullptr)));
            TEST_NO_CONTEXT_CALL((f2v(this_value, L"foo", 2)));
            TEST_NO_CONTEXT_CALL((jsrt::function<void, std::wstring>::create(nullptr)));
            TEST_NO_CONTEXT_CALL((jsrt::function<void, std::wstring>::create(L"foo", nullptr)));
            TEST_NO_CONTEXT_CALL((f1v(this_value, L"foo")));
            TEST_NO_CONTEXT_CALL((jsrt::function<void>::create(nullptr)));
            TEST_NO_CONTEXT_CALL((jsrt::function<void>::create(L"foo", nullptr)));
